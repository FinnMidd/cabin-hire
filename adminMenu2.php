...
<body>
  ...
  <a href="adminMenu.php" class='primary-button'>Active</a>
  <a href="insertCabin.php" class='primary-button'>Add Cabin</a>
  <!-- <a href="#">Deactivated</a> -->
...
<?php
  ...
  $query= "SELECT * FROM cabin WHERE cabinStatus = 'Inactive'";
  ...
  if (mysqli_num_rows($result)) {
    ...
    while($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
      ...
      #echo activate button
      echo "<td><form action='statusCabin_process.php' method='post'>";
      echo "<input type='hidden' name='cabinID' value='" . $row['cabinID'] . "'>";
      echo "<input type='submit' class='primary-button' value='Activate'>";
      echo "</form><br>";
      #echo delete button
      echo "<a href='deleteCabin_process.php?id=" . $row['cabinID'] . "' class='danger-button'>Delete</a></td>";
      echo "</tr>";
    }
    echo "</table>";
  } else {
